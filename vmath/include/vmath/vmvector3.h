...
//Outputs raw mask (by component) of the equal comparison
inline int __vectorcall VMVector3EqualRaw
(
	FVMVECTOR V1,
	FVMVECTOR V2
)
{
	VMVECTOR vTemp = _mm_cmpeq_ps(V1, V2);
	return _mm_movemask_ps(vTemp) & 7;
}

// Checks if vector is infinite
inline unsigned char __vectorcall VMVector3IsInfinite
(
	FVMVECTOR V
)
{
...
inline unsigned char __vectorcall VMVector3GreaterMasked
(
	FVMVECTOR V1,
	FVMVECTOR V2,
	uint8_t mask
